...
import { getUserStatusText, getUserStatusVariant, getRoleBadgeVariant } from '../hooks/useStaffAccountQuery'
import type { resAdminGetAllUser } from '@/types/admin.types'

interface StaffAccountDetailProps {
  user: resAdminGetAllUser | null
}

const StaffAccountDetail = ({ user }: StaffAccountDetailProps) => {
  if (!user) {
