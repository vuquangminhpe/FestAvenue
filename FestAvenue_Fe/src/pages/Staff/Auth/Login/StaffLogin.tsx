    ...
    <div className='min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4'>
      <Card className='w-full max-w-md shadow-lg'>
        <CardHeader className='text-center'>
          ...
          <CardTitle className='text-2xl font-bold text-gray-800'>Staff Login</CardTitle>
          <p className='text-gray-600'>Đăng nhập vào hệ thống Staff</p>
        </CardHeader>
        ...
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className='space-y-4'>
            ...
            <div className='space-y-2'>
              ...
              <div className='relative'>
                ...
                <Input
                  type='email'
                  placeholder='staff@festavenue.site'
          ...
          <div className='mt-6 text-center text-sm text-gray-500'>
            <p>Chỉ dành cho nhân viên được ủy quyền</p>
          </div>
        </CardContent>
      </Card>
    </div>
