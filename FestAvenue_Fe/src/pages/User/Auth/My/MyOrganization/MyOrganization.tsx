...
export default function MyOrganization() {
  ...
  const selectedOrg = organizations[selectedOrgIndex] as unknown as OrganizationResponse
                      ...
                      {isOwner && (
                        <div className='flex flex-col gap-3'>
                          ...
                          <Button
                            ...
                            onClick={() =>
                              navigate(
                                `${path.user.organization.created_organization}?updateOrganization_${generateNameId({
