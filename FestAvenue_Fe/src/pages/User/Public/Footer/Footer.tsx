    ...
    <footer className='bg-slate-700 text-white py-12 px-6'>
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8'>
          ...
          <div>
            ...
            <div className='space-y-2'>
              <p className='text-gray-300'>Mail us at</p>
              <a href='mailto:FestAvenue@Gmail.com' className='text-gray-300 hover:text-white transition-colors block'>
                FestAvenue@Gmail.com
              </a>
              <p className='text-gray-300'>Contact at</p>
              <a href='tel:0979781768' className='text-gray-300 hover:text-white transition-colors block'>
                0979781768
              </a>
              <a href='tel:0979781768' className='text-gray-300 hover:text-white transition-colors block'>
                0979781768
          ...
          {/* Newsletter Section */}
          <div>
            <h3 className='text-lg font-semibold mb-4'>For regular event updates</h3>
            <div className='mb-4'>
              <input
                type='email'
                placeholder='Enter your mail id here...'
                className='w-full px-3 py-2 bg-gray-100 text-gray-800 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500'
              />
            </div>
        ...
        <div className='border-t border-gray-600 pt-6 text-center'>
          <p className='text-gray-400 text-sm'>© FestAvenue Pvt. LTD. All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  )
