...
const Analytics = () => {
  ...
  const dashboardData = statisticsData?.data
        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className='text-2xl font-bold'>{formatNumber(general?.totalUsers ?? 0)}</div>
            )}
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className='text-2xl font-bold'>{formatNumber(general?.totalEvents ?? 0)}</div>
            )}
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className='text-2xl font-bold'>{formatNumber(general?.totalTicketsSold ?? 0)}</div>
            )}
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className='text-2xl font-bold'>{formatCurrency(general?.totalRevenue ?? 0)}</div>
            )}
          </CardContent>
        </Card>
      </div>
      ...
      <Tabs defaultValue='users' className='space-y-4'>
        ...
        <TabsContent value='users' className='space-y-4'>
          <div className='grid gap-4 lg:grid-cols-2'>
            <Card>
              ...
              <CardContent>
                <UserAnalytics data={dashboardData?.registeredUser ?? []} />
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <EmployeeAnalytics data={dashboardData?.staffMember ?? []} />
              </CardContent>
            </Card>
          </div>
        </TabsContent>
        ...
        <TabsContent value='events' className='space-y-4'>
          <div className='grid gap-4 lg:grid-cols-2'>
            <Card>
              ...
              <CardContent>
                <EventAnalytics data={dashboardData?.eventCreated ?? []} />
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <EventTypeAnalytics data={dashboardData?.eventByCategory ?? []} />
              </CardContent>
            </Card>
          </div>
          ...
          <Card>
            ...
            <CardContent>
              <EventTypeOverTimeAnalytics data={dashboardData?.eventCategoryByMonth ?? []} />
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value='revenue' className='space-y-4'>
          <Card>
            ...
            <CardContent>
              <RevenueAnalytics data={dashboardData?.monthlyRevenue ?? []} />
            </CardContent>
          </Card>
        </TabsContent>
